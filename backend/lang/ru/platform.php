...
return [
    'pages' => [
        'menu' => [
            ...
            'vacansies'=> [
                'index' => 'Вакансии',
                'description'   => 'Страница списка вакансий (для внешней части сайта)',
            ],
            'services'=> [
                'index' => 'Услуги',
    ...
    'messages' => [
        ...
        'TooMuchMemory'     => 'Вложение слишком большого объема: попробуйте уменьшить размер файла.',
    ],
    'entityes' => [
    ...
    'fuilds' => [
        ...
        'practiceStartDate' => 'Начало практики (примерно)',
        'sur_name'          => 'Отчество',
        'photo'             => 'Фото',
